    ...
    public partial class Retiro : Form
    {
        ...
        private async void btnRetirar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                OperacionViewModel resultado = await _controller.HacerRetiroAsync(cuenta, importe);
                ...
                MessageBox.Show(resultado.Resultado, "Resultado de Retiro", MessageBoxButtons.OK, icon);
